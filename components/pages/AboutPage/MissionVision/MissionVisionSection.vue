    ...
    <section>
        ...
        <div class="wrapper">
            ...
            <div class="mini-sect">
                ...
                <p>Empowering businesses and individuals with innovative, user-centric web solutions that drive
                    growth,enhance experiences, and deliver measurable results.</p>
            </div>
            <div class="stats">
